                ...
                <fieldset class="content-group">
                    ...
                    <form class="form-horizontal" action="" method="post" data-parsley-validate="true"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
<!--                                $user didapat dari public function profile yg ada di controllers Users.php , dimana
                                    $data['user'] itu sendiri diambil dari Guzzle_model->getUserById-->
                                <input type="text" name="nama" class="form-control"
                                       value="<?php echo ucwords($user['nama']); ?>" placeholder="Nama" maxlength="100">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="role" class="form-control"
                                       value="<?php echo ucwords($user['role']); ?>" placeholder="Role" maxlength="100"
                                       readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="username" class="form-control"
                                       value="<?php echo strtolower($user['username']); ?>" placeholder="Nama Pengguna">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="password" name="password2" class="form-control"
                                       value="<?php echo $user['password']; ?>" placeholder="Konfirmasi Password"
                                       required>
                            </div>
                        </div>
